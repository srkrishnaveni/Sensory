...
JNIEXPORT jstring JNICALL Java_com_sensedriver_sensesay_speechrecognizer_sensory_SensoryRecognizer_getExpirationDate( JNIEnv* env, jobject job, jlong arg)
{
    jstring res = NULL;
...
JNIEXPORT jstring JNICALL Java_com_sensedriver_sensesay_speechrecognizer_sensory_SensoryRecognizer_getLicenseExpirationDate( JNIEnv* env,jobject job, jlong arg)
{
    jstring res = NULL;
    res = (*env)->NewStringUTF(env, formatExpirationDate(sfsGetLicenseExpiration()));
    return res;
...
JNIEXPORT jlong JNICALL Java_com_sensedriver_sensesay_speechrecognizer_sensory_SensoryRecognizer_createSensorySession( JNIEnv* env,jobject job)
{
...
JNIEXPORT void JNICALL Java_com_sensedriver_sensesay_speechrecognizer_sensory_SensoryRecognizer_createRecogFromFile(JNIEnv* env,jobject job, jlong arg, jstring jnetfile, jstring jsearchfile, jlong listeningState, jlong recogMode)
{
...
JNIEXPORT void JNICALL Java_com_sensedriver_sensesay_speechrecognizer_sensory_SensoryRecognizer_initRecogForCurrentUIState( JNIEnv* env,jobject job, jlong arg, jlong listeningState)
{
    trig_t *t=(trig_t*)(long)arg;
    const char *ewhere, *ewhat=NULL;
...
JNIEXPORT jstring JNICALL Java_com_sensedriver_sensesay_speechrecognizer_sensory_SensoryRecognizer_recogPipe(JNIEnv* env,jobject job,jlong arg,jobject buffer, jlong listeningState)
{
   trig_t *t = (trig_t*)(long)arg;
...
JNIEXPORT jstring JNICALL Java_com_sensedriver_sensesay_speechrecognizer_sensory_SensoryRecognizer_getSDKVersion( JNIEnv* env, jobject job, jlong arg)
{
    jstring res = NULL;
...
JNIEXPORT void JNICALL Java_com_sensedriver_sensesay_speechrecognizer_sensory_SensoryRecognizer_closeRecog( JNIEnv* env,jobject thiz, jlong arg )
{
    trig_t *t = (trig_t*)(long)arg;
    sfs_t *sfs = t->sfs;
